...
class OutputFolderHandler(object):
    ...
    def __init__(self, base_folder, model_name=None, loss_name=None, additional_info=None, cv=None, use_timestamp=False, files_to_copy=None, stdout_file_name='output.log'):
        """
        Initializer.
    ...
    def path_for_filename_own(self, iteration=None, *paths):#多
        """
        Return the base folder plus 'iter_{iteration}/*paths'.
        :param iteration: The current iteration.
        :param paths: Paths to append (see os.path.join).
        :return: The folder.
        """
        return self.path(str(iteration), *paths)
